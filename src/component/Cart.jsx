      ...
      <div className="max-w-7xl mx-auto p-6 bg-white rounded-3xl shadow-sm border border-gray-100">
        ...
        <div className="space-y-4">
          {carts.map((cart, id) => (
            ...
            >
              ...
              <button className="text-sm font-medium text-red-500 hover:text-red-700 bg-red-50 hover:bg-red-100 px-4 py-2 rounded-lg transition-all">
                Remove
              </button>
            </div>
          ))}
        ...
        {carts.length > 0 && (
          <div className="mt-10 pt-8 border-t border-gray-100">
            ...
            <div className="px-2">
              <button className="w-full bg-gray-900 text-white py-4 rounded-2xl font-bold text-lg hover:bg-purple-600 hover:shadow-xl active:scale-[0.98] transition-all duration-300">
                Proceed to Checkout
              </button>
            </div>
          </div>
